...
class OperationalEventPanelController implements ng.IController {          public $onInit() {}
    ...
    public openRetrospective(item: iqs.shell.OperationalEvent) {
        if (item && item.object_id) {
            ...
            // this.$state.go('retrospective.map', { focus_object_id: item.object_id, retro_date: date }, { reload: true });
...
(() => {
    angular
        ...
        .component('iqsOperationalEventPanel', {
            ...
            templateUrl: 'monitoring/events/panels/OperationalEventsPanel.html',
