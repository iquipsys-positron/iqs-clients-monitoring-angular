import { IAddDeviceDialogService, IAddEqupmentDialogService } from '../../../common/dialogs';
import { IStatusService } from '../../../services';

interface IMonitoringObjectsInformationPanelBindings {
    [key: string]: any;
    object: any;
    type: any;
    editable: any;
...
const MonitoringObjectsInformationPanelBindings: IMonitoringObjectsInformationPanelBindings = {
    object: '<iqsObject',
    type: '<iqsType',
    editable: '<iqsEditable'
}

class MonitoringObjectsInformationPanelChanges implements ng.IOnChangesObject, IMonitoringObjectsInformationPanelBindings {
...
class MonitoringObjectsInformationPanelController implements ng.IController {
    ...
    public $onChanges(changes: MonitoringObjectsInformationPanelChanges): void {
        this.updateObject();
    }
    ...
    public deviceClick() {
        ...
        window.location.href = window.location.origin + `/config_devices/index.html#/devices?device_id=${this.object.device.id}`;
    }
    ...
    public carClick() {
        ...
        window.location.href = window.location.origin + `/config_objects/index.html#/objects?object_id=${this.object.object.perm_assign_id}`;
    }
...
(() => {
    ...
    angular
        .module('iqsMonitoring.Objects.InformationPanel', [
            'iqsAddDeviceDialog',
            'iqsStatus',
        ...
        .component('iqsMonitoringObjectsInformationPanel', {
            bindings: MonitoringObjectsInformationPanelBindings,
            templateUrl: 'monitoring/objects/panels/ObjectsInformationPanel.html',
            controller: MonitoringObjectsInformationPanelController,
            controllerAs: '$ctrl'
        })
