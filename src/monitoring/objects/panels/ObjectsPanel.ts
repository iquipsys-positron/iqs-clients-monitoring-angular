...
interface IMonitoringObjectsPanelBindings {
    [key: string]: any;

    type: any;
}

const MonitoringObjectsPanelBindings: IMonitoringObjectsPanelBindings = {
    type: '<iqsType'
}

class MonitoringObjectsPanelChanges implements ng.IOnChangesObject, IMonitoringObjectsPanelBindings {
    [key: string]: ng.IChangesObject<any>;

    type: ng.IChangesObject<string>;
}

class MonitoringObjectStatues {
    title: string;
    id: string;
}
class MonitoringObjectTabs {
    title: string;
    id: number;
}

class MonitoringObjectsPanelController implements ng.IController {
    public $onInit() { }
    public statuses: MonitoringObjectStatues[] = [
        {
            title: 'PEOPLE',
    ...
    public sections: MonitoringObjectTabs[] = [
        {
            title: 'INFORMATION',
            id: 0
        }, {
    ...
    public editClick() {
        ...
        //         details: 'edit'
        //     });
        window.location.href = window.location.origin + `/config_objects/index.html#/objects?object_id=${this.iqsStatesViewModel.states[this.iqsStatesViewModel.selectedIndex].object_id}&edit=edit&details=edit`;
    }
    ...
    public deviceClick(object) {
        ...
        let url = `/config_devices/index.html#/devices`;
        if (object && object.device) {
...
(() => {
    angular
        .module('iqsMonitoring.Objects.Panel', [
            'iqsObjectConfigs',
            'iqsOperationalEventPanel',
            'iqsStates.ViewModel',
            'iqsObjects.ViewModel',
        ])
        .component('iqsMonitoringObjectsPanel', {
            bindings: MonitoringObjectsPanelBindings,
            templateUrl: 'monitoring/objects/panels/ObjectsPanel.html',
            controller: MonitoringObjectsPanelController,
            controllerAs: '$ctrl'
        })
