interface IMonitoringObjectsMapPanelBindings {
    [key: string]: any;
    object: any;
    type: any;
}

const MonitoringObjectsMapPanelBindings: IMonitoringObjectsMapPanelBindings = {
    object: '<?iqsObject',
    type: '<iqsType'
}

class MonitoringObjectsMapPanelChanges implements ng.IOnChangesObject, IMonitoringObjectsMapPanelBindings {
    [key: string]: ng.IChangesObject<any>;
    object: ng.IChangesObject<iqs.shell.ControlObject>;
    type: ng.IChangesObject<string>;
}

class MonitoringObjectsMapPanelController implements ng.IController {
    public $onInit() { }
    private center: any = {};
    ...
    public $onChanges(changes: MonitoringObjectsMapPanelChanges) {
        // if (changes.object) {
        ...
        //     }
        // }
        if (changes.object && this.iqsLoading.isDone) {
...
(() => {
    angular
        .module('iqsMonitoring.Objects.MapPanel', [
            'iqsMap.ViewModel',
            'iqsStates.ViewModel',
            'iqsObjectRoutes.ViewModel',
        ])
        .component('iqsMonitoringObjectsMapPanel', {
            bindings: MonitoringObjectsMapPanelBindings,
            templateUrl: 'monitoring/objects/panels/ObjectsMapPanel.html',
            controller: MonitoringObjectsMapPanelController,
            controllerAs: '$ctrl'
        })
